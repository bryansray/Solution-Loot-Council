	...
	local options = { 
		...
		args = {
			toggle = {
				...
				type = "toggle",
				set = function() SolutionLC.isRunning() end,
				get = function() return SolutionLC:GetVariable("isRunning") end
			},
			toggleAdvanced = {
				order = 2,
					...
					testOptions = {
						...
						args = {
							...
							testRaidButton = {
								...
								func = function()
									if UnitIsGroupLeader("player") or UnitIsGroupAssistant("player") then
										SolutionLC_Mainframe.raidTestFrames(5)
							...
							versionTest = {
								...
								order = 4,
								func = function()
									SolutionLC:EnableModule("SolutionLC_VersionFrame");
									InterfaceOptionsFrame:Hide();
								end
							},
						},
							...
							addRank = {
								...
								args = {
									...
									selection = {
										...
										set = function(j,i) self.db.profile.council = {}; SolutionLC_Mainframe.setRank(i); end,
...
function SolutionLC:GetGuildOptions()
